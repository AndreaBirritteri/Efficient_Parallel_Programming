 ...
 * <p>
 * Changed to use INDEX_MAX_X and INDEX_MAX_Y as indexes where you can find max value for X and Y in x[] and y[]
 * instead of INDEX_MAX_X and INDEX_MAX_Y actually holding the max values.
 * ... making this version 2020.
 ******************************************************************************/

public class Oblig5Precode extends JFrame {
    ConvexHull d;
    IntList theCoHull;
    int n;
    int[] x, y;
    ...
    public Oblig5Precode(ConvexHull d, IntList CoHull) {
        ...
        scale = size / x[d.INDEX_MAX_X] + 0.8;
    }
    ...
    public void drawGraph() {
        ...
        setPreferredSize(new Dimension(x[d.INDEX_MAX_X] + 2 * margin, y[d.INDEX_MAX_Y] + 2 * margin));
    }
    ...
    class Graph extends JPanel {
        ...
        int yDraw(int yValue) {
            return (int) ((y[d.INDEX_MAX_Y] - yValue) * scale + margin);
        }
